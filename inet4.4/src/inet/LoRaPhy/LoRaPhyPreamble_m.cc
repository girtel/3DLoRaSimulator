...
Hz LoRaPhyPreamble::getCenterFrequency() const
{
    return this->centerFrequency;
}

void LoRaPhyPreamble::setCenterFrequency(Hz centerFrequency)
{
    handleChange();
    this->centerFrequency = centerFrequency;
}

Hz LoRaPhyPreamble::getBandwidth() const
{
    return this->bandwidth;
}

void LoRaPhyPreamble::setBandwidth(Hz bandwidth)
{
    handleChange();
...
W LoRaPhyPreamble::getPower() const
{
    return this->power;
}

void LoRaPhyPreamble::setPower(W power)
{
    handleChange();
    this->power = power;
}
...
const MacAddress& LoRaPhyPreamble::getReceiverAddress() const
{
    return this->receiverAddress;
}

void LoRaPhyPreamble::setReceiverAddress(const MacAddress& receiverAddress)
{
    handleChange();
...
LoRaPhyPreambleDescriptor::LoRaPhyPreambleDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::LoRaPhyPreamble)), "inet::FieldsChunk")
{
