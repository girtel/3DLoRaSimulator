...
#include "inet/physicallayer/wireless/common/antenna/OpalLinearPolarizationAntenna.h"
...
namespace inet::physicallayer {
    ...
    simsignal_t OpalLoRaRadioMedium::electricFieldRealSignal=cComponent::registerSignal("electricFieldRealSignal");
    simsignal_t OpalLoRaRadioMedium::electricFieldImaginarySignal=cComponent::registerSignal("electricFieldImaginarySignal");
    ...
    void OpalReceiverCallback::getField(ResultRecord r, int id) {
        if (!r.isField) {
            ...
            const_cast<cComponent*> (comp)->emit(OpalLoRaRadioMedium::electricFieldRealSignal, r.E.x);
            const_cast<cComponent*> (comp)->emit(OpalLoRaRadioMedium::electricFieldImaginarySignal, r.E.y);
    ...
    void OpalLoRaRadioMedium::loadAntennaGainFiles() {
    ...
    std::vector<std::pair<optix::int3,unsigned int> > OpalLoRaRadioMedium::loadFaceIdsFromFile(std::ifstream& infile) {
    ...
    void OpalLoRaRadioMedium::loadEdgesFromFiles() {
    ...
    void OpalLoRaRadioMedium::loadEdgeFromFile(const char* file) {
    ...
    optix::int4 OpalLoRaRadioMedium::readInt4(std::string line) {
    ...
    optix::float3 OpalLoRaRadioMedium::readFloat3(std::string line) {
    ...
    optix::float4 OpalLoRaRadioMedium::readFloat4(std::string line) {
    ...
    IWirelessSignal *OpalLoRaRadioMedium::transmitPacket(const IRadio *radio, Packet *packet)
    {
    ...
    void OpalLoRaRadioMedium::transmitInOpal(const IRadio *radio, const ITransmission *transmission) {
        ...
        transmit(id, (float) transmissionPower.get(),postx,polarization, carrierFrequency,false,false);


    }

    void OpalLoRaRadioMedium::sendToRadio(IRadio *transmitter, const IRadio *receiver, const IWirelessSignal *transmittedSignal)
    {
        ...
        if (receiver != transmitter && receiver->getReceiver() != nullptr && isPotentialReceiver(receiver, transmission)) {
            ...
            EV_DEBUG << " OpalLoRaRadioMedium::sendToRadio(): Sending " << transmittedSignal
    ...
    void OpalLoRaRadioMedium::updateCachedRecord(const IRadio *receiver, const ITransmission *transmission, ResultRecord record) {
        if (isStatic) {
    ...
    void OpalLoRaRadioMedium::finishOpalContext()
    {
        ...
        if (useDecimalDegreeDelta) {
            ...
            if (simulationType.compare("RDN")==0) {
                ...
                ((RayDensityNormalizationSimulation*)sim)->setFiltering(par("rdnFiltering"));
            } else {
    ...
    void OpalLoRaRadioMedium::receiveSignal(cComponent* source, simsignal_t signal,
        ...
        if (signal==IMobility::mobilityStateChangedSignal) {
            ...
            LoRaMedium::receiveSignal(source,signal,value,details);
        }

    }
    void  OpalLoRaRadioMedium::clearPowerCache() {
    ...
    int OpalLoRaRadioMedium::getAntennaGainId(std::string path)
    {
